...
Desenha tudo na tela
 O jogo monta um mapa usando uma matriz de caracteres. Nessa matriz ele desenha:
...
Atualiza a lógica do jogo
 Nessa parte o jogo atualiza tudo que está acontecendo:
...
Lê os comandos do jogador
 O programa verifica se o jogador apertou alguma tecla:
